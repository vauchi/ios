...
// callback. The generic QR capture node forwards each scanned chunk to
// Core as a presentation ValueChanged event.
...
struct MultipartCameraPreview: UIViewRepresentable {
    ...
    /// `Command::SwitchCamera { use_front }`. The generic node renderer recreates
...
final class MultipartCameraView: UIView {
    ...
    /// the generic QR capture node which pins the preview to 250×250
