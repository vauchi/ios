...
// `CoreScreenView(screenName: "More")`. Core's `MoreEngine` emits a
// `Component::SectionedActionList` grouping 12 navigation entries
// into four sections (primary / secondary / data / legal) since
// core 0.51.22 / `core!991` — see the shell-purity investigation
...
struct MoreView: View {
    var body: some View {
        CoreScreenView(screenName: "More")
    }
}
