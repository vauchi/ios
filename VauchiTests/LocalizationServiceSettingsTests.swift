...
// LocalizationServiceSettingsTests.swift
...
// tested elsewhere. Mirrors macOS's `LocalizationServiceSettingsTests.swift`
// and Android's `LocalizationManagerSharedPrefsTest.kt`.
